...
**Color & surface**
- Purple-to-blue (or pink-to-orange) gradient anywhere — backgrounds, buttons, headline text-fill. This is the single most recognizable AI-slop signature there is. Default to a real brand palette instead: one dominant neutral, one accent color used sparingly and consistently, not a gradient standing in for a color decision.
...
- Em-dashes and "It's not just X, it's Y" constructions used repeatedly as a rhetorical crutch
...
**2. Pick a real, constrained palette.** One neutral (not pure white/black — a warm or cool off-tone), one primary brand color used deliberately, one accent used sparingly for CTAs only. No gradients standing in for a color choice. If the brand has an existing color (logo, signage, prior materials), use it — don't override it with a "modern" palette.
